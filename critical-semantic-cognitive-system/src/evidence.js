...
/*
 Evidence Binding Module (EBM v1.0)

 Deterministic evidence binding: canonicalize input, compute hashes,
 produce evidence_unit with canonical_json for downstream layers.
*/
...
module.exports = { bindEvidence, canonicalize, sha256Canonical };
